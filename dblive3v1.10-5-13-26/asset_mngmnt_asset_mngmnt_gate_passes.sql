...
CREATE TABLE `asset_mngmnt_gate_passes` (
  `gate_pass_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `destination_location_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `destination_department_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2026-05-13 21:29:17
