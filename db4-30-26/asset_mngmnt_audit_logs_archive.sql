...
CREATE TABLE `audit_logs_archive` (
  `archive_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT (uuid()),
  `auditID` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `http_endpoint` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
