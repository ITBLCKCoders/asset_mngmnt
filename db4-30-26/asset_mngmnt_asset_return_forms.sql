...
CREATE TABLE `asset_return_forms` (
  ...
  `processor_declined_by` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `processor_decline_reason` text COLLATE utf8mb4_unicode_ci,
  `process_user_position` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
