...
CREATE TABLE `asset_borrow_requests` (
  ...
  `requested_by_signature` longtext COLLATE utf8mb4_unicode_ci,
  ...
  `processor_signature` text COLLATE utf8mb4_unicode_ci COMMENT 'Digital signature of the processor who approved the borrow request',
