...
const formStatusBadgeClass: Record<string, string> = {
  ...
  Completed: 'bg-blue-500/15 text-blue-700 border-blue-500/30 dark:text-blue-300',
  ...
  Revoked: 'bg-gray-500/15 text-gray-700 border-gray-500/30 dark:text-gray-300',
};
