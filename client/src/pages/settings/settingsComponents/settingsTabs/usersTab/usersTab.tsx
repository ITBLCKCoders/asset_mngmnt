...
export function UsersTab({ isActive }: { isActive?: boolean }) {
  ...
  // users/roles fetch resolves — avoids the flash where the skeleton
  // vanishes while tables are still loading their own states.
  const showSkeleton = isTabLoading || userManagement.loading;
  ...
  return (
    <TabsContent value="users" className="mt-0">
      {/* Nested sub-tabs — Users / Roles (same pattern as FormsTab) */}
              ...
              <div className="flex items-start justify-between gap-6">
                <div>
                  ...
                  <p className="text-white/80 mt-2">
                    Manage user accounts for global admin
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
                ...
                {hasPermission('Roles', 'create') && (
                  <RoleFormDialog
                    ...
                    modulePermissions={
                      roleManagement.rolesModulePermissions
                    }
                    setModulePermissions={
                      roleManagement.setRolesModulePermissions
                    }
                    ...
                    setShowCancelAlert={
                      roleManagement.setRolesShowCancelAlert
                    }
