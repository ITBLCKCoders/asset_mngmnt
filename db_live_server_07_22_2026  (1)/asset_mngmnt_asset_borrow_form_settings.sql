...
--
-- Table structure for table `asset_borrow_form_settings`
--

DROP TABLE IF EXISTS `asset_borrow_form_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asset_borrow_form_settings` (
...
--
-- Dumping data for table `asset_borrow_form_settings`
--

LOCK TABLES `asset_borrow_form_settings` WRITE;
/*!40000 ALTER TABLE `asset_borrow_form_settings` DISABLE KEYS */;
INSERT INTO `asset_borrow_form_settings` VALUES ('cfb28397-5a39-11f1-b8cf-00ffff729f5c','c3e9c75a-cdbb-11f0-acd5-047c16a24f9f','code','code','1050','1050',1,'MMYYYY','2026-05-28 02:06:16','65abe729-c369-447e-a864-a8e98b74b842','2026-05-28 02:06:16','65abe729-c369-447e-a864-a8e98b74b842',NULL,NULL),('ef21f78e-84a7-11f1-8cc2-b8cb29c59adf','21a225aa-cdbc-11f0-acd5-047c16a24f9f','code','none','1050','1050',1,'MMYYYY','2026-07-21 02:00:23','476e06e6-2f5f-46d0-8292-5fde561a37b4','2026-07-21 02:00:23','476e06e6-2f5f-46d0-8292-5fde561a37b4',NULL,NULL);
/*!40000 ALTER TABLE `asset_borrow_form_settings` ENABLE KEYS */;
UNLOCK TABLES;
