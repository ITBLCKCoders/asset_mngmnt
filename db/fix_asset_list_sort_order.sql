-- Sort asset list by the last 5 digits (sequence number) descending
-- This properly orders BOTH Admin and IT assets by their asset code number.
USE asset_mngmnt;
...
BEGIN
    ...
    ORDER BY CAST(RIGHT(a.asset_code, 5) AS UNSIGNED) DESC, a.asset_code;
END;;

DELIMITER ;

SELECT 'sp_get_assets updated — ordered by last 5 digits of asset_code DESC.' AS result;
