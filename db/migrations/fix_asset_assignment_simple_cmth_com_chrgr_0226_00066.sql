-- Simple Fix: Completely rebuild assets_data for the accountability form
-- This avoids complex JSON operations and ensures correct data structure
...
-- Get all assets currently assigned to this form's user
-- Rebuild assets_data with correct structure
