...
CREATE TABLE `sessions` (
  ...
  CONSTRAINT `fk_session_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`users_id`) ON DELETE CASCADE
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `before_insert_sessions` BEFORE INSERT ON `sessions` FOR EACH ROW BEGIN
    IF NEW.sessions_id IS NULL THEN
        SET NEW.sessions_id = uuid_v7();
    END IF;
END */;;
DELIMITER ;
