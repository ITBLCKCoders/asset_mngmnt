...
CREATE TABLE `asset_return_forms` (
  ...
  `signed_digital_signature` longtext COLLATE utf8mb4_unicode_ci,
  ...
  `return_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `received_by` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dept_head_signed_at` datetime DEFAULT NULL,
  `dept_head_digital_signature` longtext COLLATE utf8mb4_unicode_ci,
  ...
  `it_manager_digital_signature` longtext COLLATE utf8mb4_unicode_ci,
