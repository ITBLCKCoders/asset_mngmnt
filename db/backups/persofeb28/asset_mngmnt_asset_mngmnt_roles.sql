...
CREATE TABLE `asset_mngmnt_roles` (
  ...
  `asset_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'it | admin',
  `manager_role` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'none | itManager | adminManager | overallManager',
...
-- Dump completed on 2026-02-28 16:14:36
