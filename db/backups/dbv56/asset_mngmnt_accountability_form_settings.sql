...
CREATE TABLE `accountability_form_settings` (
  ...
  `company_format` enum('code','prefix','none') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'code',
  `department_format` enum('code','prefix','none') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
  `it_asset_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_asset_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `include_date` tinyint(1) NOT NULL DEFAULT '1',
  `date_format` enum('MMYYYY','YYYYMMDD') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'MMYYYY',
...
INSERT INTO `accountability_form_settings` VALUES ('149a1bae-f39c-11f0-8089-b42e99f23680','c3e9c75a-cdbb-11f0-acd5-047c16a24f9f','code','code','1021','6012',1,'MMYYYY','2026-01-17 12:00:13','65abe729-c369-447e-a864-a8e98b74b842','2026-01-17 12:00:13','65abe729-c369-447e-a864-a8e98b74b842',NULL,NULL);
