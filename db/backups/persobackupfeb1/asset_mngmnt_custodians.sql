...
CREATE TABLE `custodians` (
  ...
  `asset_type` enum('it','admin') COLLATE utf8mb4_unicode_ci NOT NULL,
  `manager_role` enum('none','itManager','adminManager','overallManager') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'none',
