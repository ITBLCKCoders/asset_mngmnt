...
CREATE TABLE `websocket_connections` (
  `connectionID` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `idx_websocket_connections_user_id` (`user_id`),
  KEY `idx_websocket_connections_socket_id` (`socket_id`),
  CONSTRAINT `websocket_connections_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`userID`) ON DELETE CASCADE
