...
CREATE TABLE `asset_borrow_requests` (
  ...
  `received_by_signature` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `requested_by_signature` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `processor_signature` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Digital signature of the processor who approved the borrow request',
  `processor_signed_at` datetime DEFAULT NULL COMMENT 'Timestamp when the processor signed the borrow request',
  ...
  KEY `idx_borrow_requests_received_at` (`received_at`),
